...
files = {
    "Naive LSTM": [
        "model_info/lstm_naive_hour_losses.json",
        r"$M_{Naive}$",
        "#8785BA",
        "*",
        "solid",
    ...
    "Stacked LSTM": [
        "model_info/lstm_stacked_hour_losses.json",
        r"$M_{Stacked}$",
        "#C195C4",
        "d",
        "dashdot",
    ...
    "Sequence 2 Sequence Additive LSTM without regularization": [
        "model_info/lstm_seq2seq_additive_no_regularization_hour_losses.json",
        r"$M_{Seq2Seq}$",
        "#95AAD3",
        "^",
        "dashed",
    ...
    "Sequence 2 Sequence Additive LSTM": [
        "model_info/lstm_seq2seq_additive_hour_losses.json",
        r"$M_{RegSeq2Seq}$",
        "#06948E",
        "v",
        "dotted",
...
for model, details in data.items():
    ...
    plt.plot(
        ...
        linewidth=1,
        alpha=0.7,
    )  # Set markersize to 0 for the line
